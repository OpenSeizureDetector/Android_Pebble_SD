...
public class ActivityMainSimple extends AppCompatActivity {
    static final String TAG = "ActivityMainSimple";
    ...
    protected void onStart() {
        ...
        TextView tv;
        tv = (TextView) findViewById(R.id.versionTvSimple);
    ...
    final Runnable serverStatusRunnable = new Runnable() {
        public void run() {
            ...
            TextView tv;
            if (mUtil.isServerRunning()) {
                LinearLayout ll = (LinearLayout) findViewById(R.id.statusLayoutSimple);
                ll.setBackgroundColor(okColour);
                ll = (LinearLayout) findViewById(R.id.watchStatusLl);
                ll.setBackgroundColor(okColour);

                tv = (TextView) findViewById(R.id.serverStatusTvSimple);
                if (mConnection.mBound) {
